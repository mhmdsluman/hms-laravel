    ...
    const form = useForm({
        service_id: props.inventoryItem.service_id,
        quantity_in_stock: props.inventoryItem.quantity_in_stock,
        batch_number: props.inventoryItem.batch_number,
        expiry_date: props.inventoryItem.expiry_date,
        location: props.inventoryItem.location,
    });
    ...
    <template>
        ...
        <AuthenticatedLayout>
            <template #header>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Stock Item</h2>
            </template>
            <div class="py-12">
                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            <form @submit.prevent="submit">
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label for="quantity_in_stock" class="block font-medium text-sm text-gray-700">Quantity in Stock</label>
                                ...
                                <div class="flex items-center justify-end mt-6">
                                    ...
                                    <button type="submit" :disabled="form.processing" class="ml-4 px-4 py-2 bg-green-600 text-white rounded-md">Update Stock</button>
                                </div>
                            </form>
                        </div>
                    </div>
