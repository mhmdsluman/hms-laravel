...
const submit = () => {
    form.post(route('insurance-providers.store'));
};
</script>
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add New Insurance Provider</h2>
        </template>
        <div class="py-12">
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form @submit.prevent="submit">
                            ...
                            <div class="flex items-center justify-end mt-6">
                                ...
                                <button type="submit" :disabled="form.processing" class="ml-4 px-4 py-2 bg-blue-600 text-white rounded-md">Save Provider</button>
                            </div>
                        </form>
                    </div>
                </div>
